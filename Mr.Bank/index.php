...
<html lang="en">
  <head>
    ...
    <title>Mr. virus Bank</title>

    <link rel="icon" href="fi fi-bs-bank</i>" type="image/icon type">
  </head>
      ...
      <!-- Activity section -->
            <div class="row activity text-center">
                  ...
                  <div class="col-md act">
                    <img src="image/transfer.jpg" class="img-fluid">
                    <br>
                    <a href="About Us.html"><button style="background-color : #2785C4;">About Us</button></a>
                  </div>
            </div>
      </div>
